...
export default function ProductPageTemplateV3({
  product,
  allProducts,
  ...
  return (
    <>
      ...
      {/* PAGE 1 — Cover (enlarged 1.5x) */}
      <CoverSection product={effectiveProduct} />

      {/* Sticky page tabs — centered glass capsule */}
      <nav className="sticky top-0 z-40 -mt-px px-2">
