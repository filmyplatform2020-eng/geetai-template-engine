...
const TOTAL_SCROLL_OFFSET = FIXED_HEADER_HEIGHT + HEADER_LAYER_3 + 12
...
export default function ProductPageTemplateV6({
  product,
  allProducts,
  ...
  return (
    <>
      ...
      <nav
        className="sticky z-50 px-2"
        style={{ top: FIXED_HEADER_HEIGHT }}
      >
        <div
          className="mx-auto flex max-w-2xl items-center justify-center gap-0.5 rounded-full px-1 py-1.5"
          style={{
            background: "rgba(255,255,255,0.82)",
            backdropFilter: "blur(24px)",
            WebkitBackdropFilter: "blur(24px)",
            boxShadow: "0 2px 20px rgba(138,158,216,0.08), 0 1px 4px rgba(0,0,0,0.04), 0 0 0 1px rgba(255,255,255,0.5)",
          }}
        >
          {pageTabs.map((tab, i) => (
            <button
